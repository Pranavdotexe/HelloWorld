...
>>>>>>> 36d925b87dc35fa31d5d222718b2f5f7754fb103
  ...
  return (
    <div className="app-shell">
      <div style={{ display: 'flex', minHeight: '100vh' }}>
        <div style={{ display: 'none', minWidth: shellWidth }} className="desktop-sidebar" />
        <div style={{ position: 'fixed', inset: 0, width: shellWidth + 32, display: 'none' }} className="desktop-sidebar">
          {renderSidebar()}
        </div>
            ...
            <div className="topbar-blur glass-panel" style={{ borderRadius: 28, padding: '1rem 1.2rem', marginBottom: '1rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <div style={{ padding: '0.65rem 0.85rem', borderRadius: 16, background: 'rgba(148, 163, 184, 0.08)', color: 'var(--text-secondary)', fontSize: '0.82rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.7rem', padding: '0.5rem', borderRadius: 18, background: 'rgba(148, 163, 184, 0.06)' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.88rem', fontWeight: 700 }}>{user?.department?.name || 'Central Operations'}</div>
                    </div>
                  </div>
                </div>
              </div>
